...
pub use cli_core::environment::{
    ...
    codespace_name, first_party_dev, get_theme_kit_access_domain, gitpod_url,
    home_directory, is_cloud_environment, is_development, is_shopify, is_terminal_interactive,
    is_unit_test, is_verbose, theme_token,
};
